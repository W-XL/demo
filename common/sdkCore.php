...
class sdkCore{
    ...
    public $i18n = array(
        'en' => array(
            'feedback' => array(
                'Feedback' => 'Feedback',//客服工单
                'AccountAppeal' => 'Account Appeal',//账号找回
                'ServiceOnline' => 'Customer service online time',//在线客服时间
                'MyService' => 'My customer service record',//我的客服记录
                'ServiceRecord' => 'Customer Service Record',//我的客服记录
                'Proccessed' => 'proccessed',//已处理
                'Waiting' => 'waiting',//待处理、待回复
                'Loading' => 'loading',//加载中
                'NoRecord' => 'No record',//没有提交的记录
                'Next' => 'Next',//下一页
                'SelectProblem' => 'Please select the problem type',//请选择类型
                'SelectServer' => 'Please select the server',//请选择服务器
                'WithYourAccount' => "Please describe what's wrong with your account",//描述下你的问题呗
                'Submit' => 'Submit',
                'RechargingProblems' => 'Recharging problems',//充值问题
                'AccountProblems' => 'Account problems',//账号问题
                'GamingIssues' => 'Gaming issues',//游戏问题
                'Other' => 'Other',//其他问题
                'Reply1' => 'Your appeal at',//您在
                'Reply2' => 'is waiting to be processed and the result will be sent to your',//提交的申请，等待受理中，处理结果讲会通过提供的QQ或者手机号进行回复，请您耐心等待。
                'Prompt' => 'Please fill in relative infos which will increase the probability to get back your account.',//请耐心的填写相关信息,找回账号概率会加大。
                'Email' => 'Email',//邮箱
                'AccountID' => 'Account ID',//账号id
                'RegisterTime' => 'register time',//注册时间
                'LastLoginTime' => 'last login time',//最后登录时间
                'UserInfo' => 'user info',//信息描述
                'DeviceInfo' => 'device info',//设备信息
                'RechargeInfo' => 'recharge info',//充值信息
                'DeviceDesc' => 'Please enter your device name and system number',//设备名称,系统号
                'RechargeDesc' => 'Please enter your recharge desc or offer the order screenshot',//充值描述
                'IDBlank' => "Account ID can't be blank",//账号ID不能为空
                'SelectRegisterTime' => "Please select the registered time of your account",//请选择注册时间
                'SelectLastTime' => "Please select the last login time of your account",//请选择最后登录时间
                'UserInfoBlank' => "The user info can't be blank",//信息描述不能为空
                'DeviceBlank' => "The device info can't be blank",//设备信息不能为空
                'RechargeBlank' => "The recharge info can't be blank",//充值信息不能为空
        ...
        'zh-cn'=> array(
            'feedback' => array(
                'Feedback' => '客服工单',//客服工单
                'AccountAppeal' => '账号找回',//账号找回
                'ServiceOnline' => '在线客服时间',//在线客服时间
                'MyService' => '我的客服记录',//我的客服记录
                'ServiceRecord' => '客服记录',//我的客服记录
                'Proccessed' => '已处理',//已处理
                'Waiting' => '待处理',//待处理、待回复
                'Loading' => '加载中',//加载中
                'NoRecord' => '没有提交的记录',//没有提交的记录
                'Next' => '下一页',//下一页
                'SelectProblem' => '请选择类型',//请选择类型
                'SelectServer' => '请选择服务器',//请选择服务器
                'WithYourAccount' => "描述下你的问题呗",//描述下你的问题呗
                'Submit' => '提交',
                'RechargingProblems' => '充值问题',//充值问题
                'AccountProblems' => '账号问题',//账号问题
                'GamingIssues' => '游戏问题',//游戏问题
                'Other' => '其他问题',//其他问题
                'Reply1' => '您在',//您在
                'Reply2' => '提交的申请，等待受理中，处理结果讲会通过提供的QQ或者手机号进行回复，请您耐心等待。',//提交的申请，等待受理中，处理结果讲会通过提供的QQ或者手机号进行回复，请您耐心等待。
                'Prompt' => '请耐心的填写相关信息,找回账号概率会加大。',//请耐心的填写相关信息,找回账号概率会加大。
                'Email' => '邮箱',//邮箱
                'AccountID' => '账号id',//账号id
                'RegisterTime' => '注册时间',//注册时间
                'LastLoginTime' => '最后登录时间',//最后登录时间
                'UserInfo' => '信息描述',//信息描述
                'DeviceInfo' => '设备信息',//设备信息
                'RechargeInfo' => '充值信息',//充值信息
                'DeviceDesc' => '设备名称,系统号',//设备名称,系统号
                'RechargeDesc' => '充值描述',//充值描述
                'IDBlank' => "账号ID不能为空",//账号ID不能为空
                'SelectRegisterTime' => "请选择注册时间",//请选择注册时间
                'SelectLastTime' => "请选择最后登录时间",//请选择最后登录时间
                'UserInfoBlank' => "信息描述不能为空",//信息描述不能为空
                'DeviceBlank' => "设备信息不能为空",//设备信息不能为空
                'RechargeBlank' => "充值信息不能为空",//充值信息不能为空
    ...
    public function orderid($app_id){
        $order_id = "99".$app_id.date('YmdHis').rand(10000000000,99999999999);
