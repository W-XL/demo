...
class product_admin extends adminBaseCore{
    ...
    public function product_list_view(){
        if($_POST){
            $_SESSION['app_id'] = $params = $_POST;
        }elseif(!$_GET['page']){
            unset($_SESSION['app_id']);
        }else{
            $params = $_SESSION['app_id'];
        }
    ...
    private function master_excel_out($data){
        ...
        foreach($data as $info){
            ...
            if($info['rec_type'] == 1){
                $objActSheet->setCellValue("K".$n, "Web");
            }elseif($info['rec_type'] == 2){
                $objActSheet->setCellValue("K".$n, "Google");
            }
                ...
                if ($row==1){
                    ...
                    switch ($column){
                        ...
                        case 9:
                            ...
                            if ($good_array['rec_type']=='Web'){
                                $good_array['rec_type'] = 1;
                            }else if($good_array['rec_type']=='Google'){
